...
🛡️ Privacy & Security: Advanced user control features allowing users to block or unblock contacts to maintain a secure environment.

👤 Enhanced Profiles: Detailed and customizable user profiles to foster better social engagement and identity.
...
Frontend: Built with Razor View Engine, HTML5, and CSS3 for dynamic rendering, along with JavaScript to enhance user interactivity.
